...
public class Main {
    ...
    private static Set<N15644Board> set;
    ...
    public static void main(String[] args) throws IOException {
        ...
        Queue<N15644Board> queue = new LinkedList<>();
        queue.offer(new N15644Board(redX, redY, blueX, blueY, 0, ""));
        while (!queue.isEmpty()) {
            N15644Board pop = queue.poll();
...
//            System.out.println(pop);
                    ...
                    if (pop.blueY == pop.redY) {
                        if ((command == UP && pop.blueX < pop.redX) || (command == DOWN && pop.blueX > pop.redX)) {
                            ...
                            if (bluePosition[0] == -1) {
                                ...
                                System.out.println(pop.direction + cDirection[command]);
                                System.exit(0);
                            } else if (isSame(pop.blueX, pop.blueY, bluePosition) && isSame(pop.redX, pop.redY, redPosition)) {
                                continue;
                            }

                            queue.offer(new N15644Board(redPosition[0], redPosition[1], bluePosition[0], bluePosition[1], pop.count + 1, pop.direction + cDirection[command]));
                        } else {
    ...
    static class N15644Board {
        ...
        public N15644Board(int redX, int redY, int blueX, int blueY, int count, String direction) {
            this.redX = redX;
            this.redY = redY;
            this.blueX = blueX;
            this.blueY = blueY;
        ...
        public boolean equals(Object obj) {
            ...
            N15644Board other = (N15644Board) obj;
